...
namespace DigitalRise.Geometry
{
  ...
  /// in DigitalRise Geometry because several applications built upon the library rely on the 
  /// cloning mechanism. The DigitalRise Geometry library internally does not use the cloning 
