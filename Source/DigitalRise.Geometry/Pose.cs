...
namespace DigitalRise.Geometry
{
	...
	public struct Pose : IEquatable<Pose>
	{
		...
		[Browsable(false)]
		[JsonIgnore]
		public Vector3 WorldDirection => ToWorldDirection(Vector3.Forward);
		#endregion
		...
		/// </para>
		/// <para>
		/// This method is available only in the XNA-compatible build of the DigitalRise.Geometry.dll.
		/// </para>
		/// </remarks>
		...
		public Matrix ToMatrixWithScale(Vector3 scale)
		{
			Matrix world = this;
