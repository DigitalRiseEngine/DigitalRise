...
namespace DigitalRise.Data.Meshes
{
	...
	public static partial class MeshHelper
	{
		...
		internal static int GetPrimitiveCount(this PrimitiveType primitiveType, int count)
		{
		...
		/// <overloads>
		/// <summary>
		/// Creates a <see cref="TriangleMesh"/> (DigitalRise.Geometry) for the <see cref="Mesh"/> or 
		/// <see cref="Submesh"/> (DigitalRise.Graphics).
		/// </summary>
		/// </overloads>
		///
		/// <summary>
