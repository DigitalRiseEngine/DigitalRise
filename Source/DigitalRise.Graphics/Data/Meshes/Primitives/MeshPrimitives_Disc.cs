...
namespace DigitalRise.Data.Meshes.Primitives
{
	partial class MeshPrimitives
	{
		...
		public static Mesh CreateDiscMesh(float radius = 0.5f, float sectorAngle = 2 * MathF.PI, int tessellation = 16, float uScale = 1.0f, float vScale = 1.0f, bool toLeftHanded = false)
		{
			if (tessellation < 4)
				tessellation = 4;
