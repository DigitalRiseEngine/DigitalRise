...
namespace DigitalRise.Misc
{
	...
	internal struct RenderStateSnapshot
	{
		...
		public void Restore()
		{
			...
			var graphicsDevice = DR.GraphicsDevice;
			graphicsDevice.BlendState = _blendState ?? BlendState.Opaque;
			graphicsDevice.DepthStencilState = _depthStencilState ?? DepthStencilState.Default;
			graphicsDevice.RasterizerState = _rasterizerState ?? RasterizerState.CullCounterClockwise;
