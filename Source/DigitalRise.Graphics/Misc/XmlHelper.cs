...
namespace DigitalRise.Misc
{
	...
	internal static class XmlHelper
	{
		...
		/// </exception>
		public static string GetMandatoryAttribute(this XElement element, string name)
		{
			if (element == null)
		...
		public static T ToParameterValue<T>(this XElement el, T defaultValue = default(T))
		{
			return (T)el.Attribute("Value").ToParameterValue(defaultValue);
		}
