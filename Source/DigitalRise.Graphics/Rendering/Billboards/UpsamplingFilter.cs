...
namespace DigitalRise.Rendering.Billboards
{
	...
	[Obsolete("The enum UpsamplingFilter has been renamed to avoid confusion with the new UpsampleFilter. Use the new enum DigitalRise.Graphics.PostProcessing.UpsamplingMode instead.")]
