...
namespace DigitalRise.SceneGraph.Scenes
{
	/// <summary>
	...
	/// <see cref="DigitalRise.Geometry.Collisions.CollisionDomain"/> to accelerate scene queries 
	...
	public class Scene : SceneNode
	{
		...
		private readonly List<IUpdateableNode> _updateables = new List<IUpdateableNode>();
		private bool _updateablesDirty = true;
		...
		[JsonIgnore]
		[Browsable(false)]
		public IReadOnlyList<IUpdateableNode> UpdateableNodes
		{
			get
			{
				...
				RecursiveProcess(n =>
				{
					var asUpdateable = n as IUpdateableNode;
