...
namespace DigitalRise.Animation.Traits.Tests
{
	...
	public class SingleTraitsTest
	{
		...
		public void InterpolationTest()
		{
			...
			AssertExt.AreNumericallyEqual(value1, traits.Interpolate(value0, value1, 1.0f), 1e-04);
			AssertExt.AreNumericallyEqual(0.25f * value0 + 0.75f * value1, traits.Interpolate(value0, value1, 0.75f), 1e-04);
		}
	}
}
