...
namespace DigitalRise.Animation.Traits.Tests
{
	...
	public class SrtTransformTraitsTest
	{
		...
		public void MultiplyTest()
		{
			...
			AssertExt.AreNumericallyEqual(value * value * value, traits.Multiply(value, 3), 1e-04f);
		...
		public void CycleOffsetTest()
		{
			...
			AssertExt.AreNumericallyEqual(cycleOffset.Inverse * cycleOffset.Inverse * first, traits.Add(last, traits.Multiply(cycleOffset, -3)), 1e-03f);
		}
