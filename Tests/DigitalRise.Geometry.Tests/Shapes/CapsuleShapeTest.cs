...
namespace DigitalRise.Geometry.Shapes.Tests
{
  ...
  public class CapsuleTest
  {
    ...
    {
      Assert.AreEqual(new BoundingBox(), new CapsuleShape().GetBoundingBox(Pose.Identity));
      Assert.AreEqual(new BoundingBox(new Vector3(10, 100, -13), new Vector3(10, 100, -13)),
                     new CapsuleShape().GetBoundingBox(new Pose(new Vector3(10, 100, -13),
      ...
      Assert.AreEqual(new BoundingBox(new Vector3(0, 80, 990), new Vector3(20, 120, 1010)),
                     new CapsuleShape(10, 40).GetBoundingBox(new Pose(new Vector3(10, 100, 1000),
                                                                   Quaternion.Identity)));
      // TODO: Test rotations.
    }
    ...
    //  AssertExt.AreNumericallyEqual(10, new CapsuleShape(10, 30).GetSupportPointDistance(new Vector3(1, 0, 0)));
    //  AssertExt.AreNumericallyEqual(15, new CapsuleShape(10, 30).GetSupportPointDistance(new Vector3(0, 1, 0)));
    //  AssertExt.AreNumericallyEqual(10, new CapsuleShape(10, 30).GetSupportPointDistance(new Vector3(0, 0, 1)));
    //  AssertExt.AreNumericallyEqual(10, new CapsuleShape(10, 30).GetSupportPointDistance(new Vector3(-1, 0, -1)));
    //  AssertExt.AreNumericallyEqual(MathHelper.ProjectTo(new Vector3(0, 5, 0)+10*new Vector3(1, 1, 1).Normalized, new Vector3(1, 1, 1)).Length, new CapsuleShape(10, 30).GetSupportPointDistance(new Vector3(1, 1, 1)));
    //}
    ...
    public void Clone()
    {
      ...
      Assert.AreEqual(capsule.GetBoundingBox(Pose.Identity).Min, clone.GetBoundingBox(Pose.Identity).Min);
      Assert.AreEqual(capsule.GetBoundingBox(Pose.Identity).Max, clone.GetBoundingBox(Pose.Identity).Max);
    }
