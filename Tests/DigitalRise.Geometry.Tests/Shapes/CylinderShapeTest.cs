...
namespace DigitalRise.Geometry.Shapes.Tests
{
  ...
  public class CylinderTest
  {
    ...
    {
      Assert.AreEqual(new BoundingBox(), new CylinderShape().GetBoundingBox(Pose.Identity));
      Assert.AreEqual(new BoundingBox(new Vector3(10, 100, -13), new Vector3(10, 100, -13)),
                     new CylinderShape().GetBoundingBox(new Pose(new Vector3(10, 100, -13),
                                                                         MathHelper.CreateRotation(new Vector3(1, 1, 1), 0.7f))));
      Assert.AreEqual(new BoundingBox(new Vector3(0, 80, 990), new Vector3(20, 120, 1010)),
                     new CylinderShape(10, 40).GetBoundingBox(new Pose(new Vector3(10, 100, 1000),
                                                                   Quaternion.Identity)));
      // TODO: Test rotations.
    }
    ...
    //  AssertExt.AreNumericallyEqual(10, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(1, 0, 0)));
    //  AssertExt.AreNumericallyEqual(15, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(0, 1, 0)));
    //  AssertExt.AreNumericallyEqual(10, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(0, 0, 1)));
    //  AssertExt.AreNumericallyEqual(10, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(-1, 0, -1)));
    //  AssertExt.AreNumericallyEqual(MathHelper.ProjectTo(new Vector3(0, 15, 0)+10*new Vector3(1, 0, 1).Normalized(), new Vector3(1, 1, 1)).Length, new CylinderShape(10, 30).GetSupportPointDistance(new Vector3(1, 1, 1)));
    //}
    ...
    public void Clone()
    {
      ...
      Assert.AreEqual(cylinder.GetBoundingBox(Pose.Identity).Min, clone.GetBoundingBox(Pose.Identity).Min);
      Assert.AreEqual(cylinder.GetBoundingBox(Pose.Identity).Max, clone.GetBoundingBox(Pose.Identity).Max);
    }
