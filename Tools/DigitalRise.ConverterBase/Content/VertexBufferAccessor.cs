...
namespace DigitalRise.ConverterBase.Content
{
	...
	internal class VertexBufferAccessor
	{
		...
		/// Format conversion to/from <see cref="DataFormat.R11G11B10_FLOAT"/> is not supported.
		/// </exception>
		public void SetElements(Vector2[] buffer, VertexElementSemantic semantic, int semanticIndex)
		{
			if (buffer == null)
				throw new ArgumentNullException("buffer");
		...
		/// Format conversion to/from <see cref="DataFormat.R11G11B10_FLOAT"/> is not supported.
		/// </exception>
		public void GetElements(Vector2[] buffer, VertexElementSemantic semantic, int semanticIndex)
		{
			if (buffer == null)
				throw new ArgumentNullException("buffer");
