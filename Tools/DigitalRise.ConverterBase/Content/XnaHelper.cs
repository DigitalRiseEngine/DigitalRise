...
namespace DigitalRise.ConverterBase.Content
{
	...
	internal static class XnaHelper
	{
		...
		/// <summary>
		/// Converts the specified DigitalRise <see cref="DataFormat"/> to the XNA
		...
		/// <summary>
		/// Converts the specified XNA <see cref="VertexElementFormat"/> to a DigitalRise
		/// <see cref="DataFormat"/>.
		/// </summary>
		...
		/// <summary>
		/// Converts the specified DigitalRise <see cref="VertexElementSemantic"/> to the XNA
		...
		/// <summary>
		/// Converts the specified XNA <see cref="VertexElementUsage"/> to the DigitalRise
		...
		internal static VertexElementSemantic ToVertexElementSemantic(this VertexElementUsage usage)
		{
			switch (usage)
			{
				...
				default:
					string message = string.Format(CultureInfo.InvariantCulture, "Vertex element usage ({0}) is not supported in DigitalRise Graphics.", usage);
					throw new NotSupportedException(message);
			}
		}
		...
		/// <summary>
		/// Converts the specified DigitalRise <see cref="VertexElement"/> to the XNA
		...
		/// the DigitalRise <see cref="VertexElement"/>.
		/// </summary>
		/// <param name="element">
		...
		/// <summary>
		/// Converts the specified XNA <see cref="SurfaceFormat"/> to the DigitalRise
		/// <see cref="DataFormat"/>.
		/// </summary>
