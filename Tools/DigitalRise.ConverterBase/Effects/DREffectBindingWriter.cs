...
namespace DigitalRise.ConverterBase.Effects
{
	/// <summary>
	...
	public class DREffectBindingWriter : ContentTypeWriter<DREffectBindingContent>
	{
		...
		{
			return "DigitalRise.Graphics.Effects.EffectBinding, DigitalRise.Graphics, Version=1.2.0.0";
		}
		...
		{
			return "DigitalRise.Graphics.Content.EffectBindingReader, DigitalRise.Graphics, Version=1.2.0.0";
		}
