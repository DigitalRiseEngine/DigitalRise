...
namespace DigitalRise.ConverterBase.Meshes
{
  ...
  public class DRMaterialWriter : ContentTypeWriter<DRMaterialContent>
  {
    ...
    {
      return "DigitalRise.Graphics.Material, DigitalRise.Graphics, Version=1.2.0.0";
    }
    ...
    {
      return "DigitalRise.Graphics.Content.MaterialReader, DigitalRise.Graphics, Version=1.2.0.0";
    }
