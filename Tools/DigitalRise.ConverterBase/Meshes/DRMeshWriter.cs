...
namespace DigitalRise.ConverterBase.Meshes
{
  ...
  public class DRMeshWriter : ContentTypeWriter<DRMeshContent>
  {
    ...
    {
      return "DigitalRise.Graphics.Mesh, DigitalRise.Graphics, Version=1.2.0.0";
    }
    ...
    {
      return "DigitalRise.Graphics.Content.MeshReader, DigitalRise.Graphics, Version=1.2.0.0";
    }
