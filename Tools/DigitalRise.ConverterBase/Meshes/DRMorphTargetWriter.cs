...
namespace DigitalRise.ConverterBase.Meshes
{
  ...
  public class DRMorphTargetWriter : ContentTypeWriter<DRMorphTargetContent>
  {
    ...
    {
      return "DigitalRise.Graphics.MorphTarget, DigitalRise.Graphics, Version=1.2.0.0";
    }
    ...
    {
      return "DigitalRise.Graphics.Content.MorphTargetReader, DigitalRise.Graphics, Version=1.2.0.0";
    }
