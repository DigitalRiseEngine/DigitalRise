...
namespace DigitalRise.ConverterBase.Occluder
{
	...
	public class DROccluderWriter : ContentTypeWriter<DROccluderContent>
	{
		...
		{
			return "DigitalRise.Graphics.Occluder, DigitalRise.Graphics, Version=1.2.0.0";
		}
		...
		{
			return "DigitalRise.Graphics.Content.OccluderReader, DigitalRise.Graphics, Version=1.2.0.0";
		}
