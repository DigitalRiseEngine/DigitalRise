...
namespace DigitalRise.ConverterBase.SceneGraph
{
	...
	public class DRMeshNodeWriter : ContentTypeWriter<DRMeshNodeContent>
	{
		...
		{
			return "DigitalRise.Graphics.SceneGraph.MeshNode, DigitalRise.Graphics, Version=1.2.0.0";
		}
		...
		{
			return "DigitalRise.Graphics.Content.MeshNodeReader, DigitalRise.Graphics, Version=1.2.0.0";
		}
