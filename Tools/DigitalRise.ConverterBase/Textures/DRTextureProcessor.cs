...
using Texture = DigitalRise.ConverterBase.Content.Texture;
using TextureAddressMode = DigitalRise.ConverterBase.Content.TextureAddressMode;


namespace DigitalRise.ConverterBase.Textures
{
	/// <summary>
