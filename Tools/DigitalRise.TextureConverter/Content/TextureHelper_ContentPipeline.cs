...
namespace DigitalRise.TextureConverter.Content
{
	partial class TextureHelper
	{
		...
		/// <summary>
		/// Converts an XNA <see cref="TextureContent"/> to a DigitalRise <see cref="Texture"/>.
		/// </summary>
		...
		/// <summary>
		/// Converts a DigitalRise <see cref="Texture"/> to an XNA <see cref="TextureContent"/>.
		/// </summary>
		...
		/// <summary>
		/// Converts a DigitalRise <see cref="Image"/> to an XNA <see cref="BitmapContent"/>.
		/// </summary>
