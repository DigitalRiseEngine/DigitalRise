...
using Texture = DigitalRise.TextureConverter.Content.Texture;
using TextureAddressMode = DigitalRise.TextureConverter.Content.TextureAddressMode;


namespace DigitalRise.TextureConverter.Textures
{
	/// <summary>
	/// Processes a model texture.
	/// </summary>
	public class DRTextureProcessor
	{
		...
		/// </exception>
		public Texture Process(TextureContent input)
		{
			if (input == null)
			...
			// See section "Alpha Blending" in DigitalRise KB.)
